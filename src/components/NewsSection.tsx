    ...
    <div className="flex flex-col">
      <div className="my-6 flex w-full gap-3 max-md:flex-col">
        <div className="grid w-[100%] grid-cols-2 gap-2 md:w-[66%]">
          <News title="Technology" image={b1} />
          <News title="Science" image={b2} />
          <News title="Health" image={b2} />
          <News title="Culture and Art" image={b2} />
        </div>

        <div className="w-[100%] md:w-[33%]">
          <h1 className="px-10 py-2 text-xl font-bold">Popular</h1>
